...
module.exports = class StopResourceCommand extends Commando.Command {
  constructor(client) {
    super(client, {
      name: "stop",
      group: "fivem",
      memberName: "stop",
      description: i18n.__("stop_command_description"),
      argsType: "single",
      userPermissions: ["ADMINISTRATOR"],
      examples: [".stop esx_ambulancejob"],
    });
  }
  ...
  async run(message, args) {
    ...
    cl.on("response", function (str) {
      if (str.startsWith(`rint ^3Couldn't find resource`)) {
        ...
        return;
      } else if (str.startsWith(`rint Argument count mismatch`)) {
        const noArguments = new MessageEmbed()
          .setColor("#39435b")
          .setDescription(
            i18n.__("no_resource_provided", {
              action: i18n.__("action_stop"),
            })
          );
        message.embed(noArguments);
        return;
        ...
        const serverOutput = new MessageEmbed()
          .setTitle(i18n.__("resource_stopped"))
